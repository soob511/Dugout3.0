...
<nav aria-label="Page navigation example"
	...
	<ul class="pagination">
		<li class="page-item"><a class="page-link" href="?pageNo=1&sort=${param.sort}"
		...
		<li class="page-item"><c:if test="${pager.groupNo>1}">
				<a class="page-link" href="?pageNo=${pager.startPageNo - 1}&sort=${param.sort}"
		...
		<c:forEach begin="${pager.startPageNo}" end="${pager.endPageNo}"
			...
			<c:if test="${pager.pageNo == i}">
				<li class="page-item active"><a href="?pageNo=${i}&sort=${param.sort}"
					class="page-link">${i}</a></li>
			</c:if>
			<c:if test="${pager.pageNo != i}">
				<li class="page-item"><a href="?pageNo=${i}&sort=${param.sort}" class="page-link">${i}</a></li>
			</c:if>
		</c:forEach>

		<li class="page-item"><c:if
				test="${pager.groupNo<pager.totalGroupNo}">
				<a class="page-link" href="?pageNo=${pager.endPageNo + 1}&sort=${param.sort}"
		...
		<li class="page-item"><a class="page-link"
			href="?pageNo=${pager.totalPageNo}&sort=${param.sort}" aria-label="Last"> <span
