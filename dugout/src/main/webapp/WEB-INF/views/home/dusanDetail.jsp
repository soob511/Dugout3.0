...
<html>
  <head>
    ...
    <link rel="stylesheet" href="DusanDetail.css" />
    <script src="DusanDetail.js"></script>
  </head>
  <body>
    <main id="recomm-main">
      <section
      ...
      >
        <div>
          <p class="product-count"><span>4</span>개의 상품 검색</p>
        </div>
        <div class="d-flex">
          <div class="me-3">
            <button
        ...
        <div class="d-flex justify-content-center">
          ...
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/어센틱원정유니폼오더.jpg"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
              <p class="card-title">[두산베어스]어센틱 원정 유니폼 오더</p>
              <p class="card-text">유니폼</p>
              <p class="card-text2">90,000원</p>
            </div>
          </div>
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[두산베어스] 어센틱 썸머 유니폼.jpg"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
              <p class="card-title">[두산베어스] 어센틱 썸머 유니폼</p>
              <p class="card-text">유니폼</p>
              <p class="card-text2">90,00원</p>
            </div>
          </div>
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[두산베어스] 피규어V7춘식이.jpg"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
        ...
        <div class="d-flex justify-content-center hide-section">
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[국가대표] 패턴 리본머리띠 (BLUE).jpg"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
        ...
        <div class="d-flex justify-content-center hide-section">
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[국가대표] 야구대표팀 반팔바람막이.jpg"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
          ...
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[삼성라이온즈] 레플리카 홈 유니폼.png"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
          ...
          <div class="card" style="width: 300px; height: 500px">
            <a href="../productDetails/PoductDetails.html"
              ><img
                class="card-img-top"
                src="../common/image/product/[삼성라이온즈] 레플리카 원정 유니폼.png"
                height="150"
            /></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
