        ...
        <form class="row g-3" method="post" action="join">
            <fieldset class="col-12">
                <div class="mb-3 form-group">
                    ...
                    <div class="d-flex">
                        <input type="text" class="form-control" id="inputId" placeholder="예) dugout (영문 또는 숫자 4~12자리)" name="userId" />
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="password" class="form-control" id="inputPassword" placeholder="영문, 숫자 조합 8 ~ 16자" name="userPassword" value="${userDto.password}" />
