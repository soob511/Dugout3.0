...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/user/findId.css" rel="stylesheet" />
    <script src="${pageContext.request.contextPath}/resources/js/user/findId.js"></script>
        ...
        <div class="findid-container" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <form class="findid-form">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="userName" class="form-control" placeholder="이름을 입력하세요">
                </div>
                <div class="form-group">
                    <label for="phone">전화번호</label>
                    <input type="text" id="phone" name="userPhone" class="form-control" placeholder="전화번호를 입력하세요">
