...
<link
	href="${pageContext.request.contextPath}/resources/css/notice/noticeForm.css"
	rel="stylesheet" />
</head>
<body>
	...
	<div class="container">
		<div
			class="notice-insert-box d-flex justify-content-between align-items-center">
			<h2 class="notice-insert-title">공지사항 작성</h2>
		</div>
		<form id="writeNoticeForm" method="post" action="writeNotice">
			<div class="form-group">
				<label for="noticeTitle">제목</label> <input id="noticeTitle"
					type="text" name="noticeTitle" class="form-control">
			</div>
