				...
				<tbody>
					<tr>
						...
						<td><input type="text" class="form-control"
							placeholder="89,000원"></td>
						<td><input type="text" class="form-control" placeholder="8"></td>
						<td><select class="form-select">
								<option value="판매 중" selected>판매 중</option>
								<option value="품절">품절</option>
						</select></td>
						<td><button class="btn btn-dark" onclick="saveData()">수정하기</button></td>
					</tr>
					...
					<tr>
						<td><input type="checkbox"></td>
						<td><img src="../common/image/purchaseProducts/ssgCap.jpg"
							class="img-thumbnail" alt="상품 이미지"></td>
						<td>
							<div class="d-flex">
								<select class="form-select me-2">
					...
					<tr>
						<td><input type="checkbox"></td>
						<td><img src="../common/image/purchaseProducts/samsungJacket.jpg" class="img-thumbnail"
							alt="상품 이미지"></td>
						<td>
							<div class="d-flex">
								<select class="form-select me-2">
