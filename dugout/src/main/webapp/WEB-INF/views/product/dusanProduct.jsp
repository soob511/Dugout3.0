...
<main id="recomm-main">
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="card" style="width: 300px; height: 500px;">
        <a href="../productDetails/PoductDetails.html"><img class="card-img-top" src="../common/image/product/어센틱원정유니폼오더.jpg" height="150"></a>
            <i class="bi bi-heart"></i>
            <div class="card-body">
        ...
        <div class="card" style="width: 300px; height: 500px;">
        <a href="../productDetails/PoductDetails.html"><img class="card-img-top" src="../common/image/product/[두산베어스] 어센틱 썸머 유니폼.jpg" height="150"></a>                
            <i class="bi bi-heart"></i>
            <div class="card-body">
