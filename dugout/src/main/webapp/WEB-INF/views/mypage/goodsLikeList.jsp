		...
		<div id="heartlist-container">
			<section>
				<div class="heart-title-box">
					...
					<button type="button" class="heart-delete-all"
						onclick="deleteAllLikes()">전체 삭제</button>
				</div>
			</section>
				...
				<section class="heart-list-section">
					<div class="heart-list">
						...
						<div class="heart-info">
							<span>[${item.goodsTeam}] ${item.goodsName}</span><br> <span><fmt:formatNumber
									value="${item.goodsPrice}" pattern="#,###" />원</span>
						</div>
					</div>
