        ...
        <div class="purchase-history">
            ...
            <div class="purchase-period-buttons">
                <a href="${pageContext.request.contextPath}/order/orderList">
                    <button class="recent6-month-btn ${param.recentMonth == null || param.recentMonth == '6' ? 'active' : ''}">최신6개월</button>
                </a>
                <a href="${pageContext.request.contextPath}/order/orderList?recentMonth=12">
                    <button class="recent1-year-btn ${param.recentMonth == '12' ? 'active' : ''}">최신1년</button>
                </a>
            </div>
                                ...
                                <div style="width: 830px;">
                                    <div class="purchase-item-details">
                                        ...
                                        <div class="purchase-item-price">
                                            주문금액 : 총 <fmt:formatNumber value="${item.orderTotalPrice}" pattern="#,###,###"></fmt:formatNumber> 원
                                        </div>
                                    </div>
                                </div>
                            </button>
                                ...
                                <c:forEach items="${orderItemList[status.index]}" var="order">
                                    <div class="purchase-item">
                                        ...
                                        <div class="purchase-item-details">
                                            ...
                                            <div class="purchase-item-price">
                                                <fmt:formatNumber value="${order.orderItemPrice}" pattern="#,###,###"></fmt:formatNumber> 원 / ${order.orderItemCount}개
                                            </div>
                                            <div class="purchase-item-price">
                                                <fmt:formatNumber value="${order.orderItemPrice * order.orderItemCount}" pattern="#,###,###"></fmt:formatNumber> 원
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
