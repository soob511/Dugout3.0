   ...
   <section class="section-top">
	<div class="d-flex align-items-center">
		...
		<nav aria-label="Page navigation example"
			...
			<ul class="pagination">
				<li class="page-item"><a class="page-link" href="?pageNo=1&val=${param.val}"
				...
				<li class="page-item"><c:if test="${pager.groupNo>1}">
						<a class="page-link" href="?pageNo=${pager.startPageNo - 1}&val=${param.val}"
				...
				<c:forEach begin="${pager.startPageNo}" end="${pager.endPageNo}"
					...
					<c:if test="${pager.pageNo == i}">
						<li class="page-item active"><a href="?pageNo=${i}&val=${param.val}"
							class="page-link">${i}</a></li>
					</c:if>
					<c:if test="${pager.pageNo != i}">
						<li class="page-item"><a href="?pageNo=${i}&val=${param.val}"
							class="page-link">${i}</a></li>
					</c:if>
				</c:forEach>
				...
				<li class="page-item"><c:if
						...
						<a class="page-link" href="?pageNo=${pager.endPageNo + 1}&val=${param.val}"
				...
				<li class="page-item"><a class="page-link"
					href="?pageNo=${pager.totalPageNo}&val=${param.val}" aria-label="Last"> <span
